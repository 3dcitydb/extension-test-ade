...
public class WritingADE {
    ...
    public static void main(String[] args) throws Exception {
        ...
        industrialBuilding.setDateOfConstruction(building.getDateOfConstruction());
        industrialBuilding.setDateOfDemolition(building.getDateOfDemolition());
        industrialBuilding.setHeights(building.getHeights());
        ...
        industrialBuildingPart.setRemark("remark");
        industrialBuilding.getBuildingParts().add(new BuildingPartProperty(industrialBuildingPart));
        ...
        industrialBuildingPart.addADEProperty(buildingProperties);
        ...
        AbstractBuildingUndergroundProperty unitProperty = new AbstractBuildingUndergroundProperty(buildingUnderground);
